...
**Assets**
`operationId`: `_web_api_xdr_assets_surface_identity_get`

Get identity surface assets
...
**Perform action**
`operationId`: `_web_api_xdr_assets_surface_identity_action_post`
...
**Available actions**
`operationId`: `_web_api_xdr_assets_surface_identity_available-actions_with-status_post`
...
`operationId`: `_web_api_xdr_assets_surface_identity_export_get`
