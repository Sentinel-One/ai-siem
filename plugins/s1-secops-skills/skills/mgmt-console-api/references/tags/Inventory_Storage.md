...
**Assets**
`operationId`: `_web_api_xdr_assets_storage_get`
...
**Assets using POST**
`operationId`: `_web_api_xdr_assets_storage_post`
...
**Perform action**
`operationId`: `_web_api_xdr_assets_storage_action_post`
...
- `scanStatus` [query, array]: The CDS malware scan status
- `cloudProviderProjectId__contains` [query, array]: The cloud provider project ID
- `body` [body, v2_1.inventory.storage.schemas_StorageActionPayloadSchema]: 

Responses: 200 Success, 400 Invalid user input received. See error details for further i, 401 Unauthorized access - please sign in and retry.

## `POST /web/api/v2.1/xdr/assets/storage/available-actions/with-status`
**Available actions**
`operationId`: `_web_api_xdr_assets_storage_available-actions_with-status_post`
...
`operationId`: `_web_api_xdr_assets_storage_export_get`
