# Inventory Data Analysis Filters
...
**Auto Complete**
`operationId`: `_web_api_xdr_assets_data-analysis_filters_autocomplete_get`
...
**Filter counts**
`operationId`: `_web_api_xdr_assets_data-analysis_filters_count_get`
...
## `GET /web/api/v2.1/xdr/assets/data-analysis/filters/free-text`

**Free text filters**
`operationId`: `_web_api_xdr_assets_data-analysis_filters_free-text_get`
