# Inventory Identity Surface Filters

3 endpoints.

## `GET /web/api/v2.1/xdr/assets/surface/identity/filters/autocomplete`
**Auto Complete**
`operationId`: `_web_api_xdr_assets_surface_identity_filters_autocomplete_get`
...
**Filter counts**
`operationId`: `_web_api_xdr_assets_surface_identity_filters_count_get`

Get identity filter counts
...
**Free text filters**
`operationId`: `_web_api_xdr_assets_surface_identity_filters_free-text_get`
