# Inventory Developer Tool Filters

3 endpoints.

## `GET /web/api/v2.1/xdr/assets/developer-tool/filters/autocomplete`
**Auto Complete**
`operationId`: `_web_api_xdr_assets_developer-tool_filters_autocomplete_get`
...
## `GET /web/api/v2.1/xdr/assets/developer-tool/filters/count`
**Filter counts**
`operationId`: `_web_api_xdr_assets_developer-tool_filters_count_get`
...
## `GET /web/api/v2.1/xdr/assets/developer-tool/filters/free-text`
**Free text filters**
`operationId`: `_web_api_xdr_assets_developer-tool_filters_free-text_get`
