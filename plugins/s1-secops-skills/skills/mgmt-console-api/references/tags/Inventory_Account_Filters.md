# Inventory Account Filters

3 endpoints.

## `GET /web/api/v2.1/xdr/assets/account/filters/autocomplete`
**Auto Complete**
`operationId`: `_web_api_xdr_assets_account_filters_autocomplete_get`
...
## `GET /web/api/v2.1/xdr/assets/account/filters/count`
**Filter counts**
`operationId`: `_web_api_xdr_assets_account_filters_count_get`
...
## `GET /web/api/v2.1/xdr/assets/account/filters/free-text`
**Free text filters**
`operationId`: `_web_api_xdr_assets_account_filters_free-text_get`
