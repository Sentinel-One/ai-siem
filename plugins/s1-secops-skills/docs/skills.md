...
**Playbooks:** `references/data-source-onboarding.md`, `references/asset-enrichment.md`, `references/ueba-anomaly-detection.md`, `references/ingest-health-monitoring.md`, `references/scheduled-detection-exclusions.md`, `references/risk-based-alerting.md`, `references/detection-as-code.md`. Add new solutions as `references/<solution>.md` plus templates, and name them in the skill description so they trigger.
