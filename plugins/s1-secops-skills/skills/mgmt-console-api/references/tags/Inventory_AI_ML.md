...
## `GET /web/api/v2.1/xdr/assets/ai-ml`
**Assets**
`operationId`: `_web_api_xdr_assets_ai-ml_get`
...
## `POST /web/api/v2.1/xdr/assets/ai-ml`
**Assets using POST**
`operationId`: `_web_api_xdr_assets_ai-ml_post`
...
- `siteIds` [query, array]: List of Site IDs to filter by
- `groupIds` [query, array]: List of Group IDs to filter by
- `body` [body, v2_1.inventory.ai_ml.schemas_AIMLViewInputSchema]: 

Responses: 200 Success, 400 Invalid user input received. See error details for further i, 401 Unauthorized access - please sign in and retry.

## `POST /web/api/v2.1/xdr/assets/ai-ml/action`
**Perform action**
`operationId`: `_web_api_xdr_assets_ai-ml_action_post`
...
**Available actions**
`operationId`: `_web_api_xdr_assets_ai-ml_available-actions_with-status_post`
...
## `GET /web/api/v2.1/xdr/assets/ai-ml/export`
**Export assets to CSV or JSON**
`operationId`: `_web_api_xdr_assets_ai-ml_export_get`
